...
```pip -V```
 ...
 ### Answers 3 - 6:
 Located in the [jupyter notebook](taxi_questions03-06.ipynb) script.

 ## Question 7. Terraform Workflow

 ### Answer 7:
 Established `.devcontainer` to run in codespaces. Created a [main.tf](./terraform/main.tf) with untracked `variables.tf` file to test the CLI commands.
